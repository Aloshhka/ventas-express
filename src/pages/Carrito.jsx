...
function Carrito() {
  ...
  const { carrito, quitarDelCarrito, cambiarCantidad, totalPrecio } =
    useCarrito();
      ...
      <div className="max-w-4xl mx-auto p-8">
        ...
        {carrito.length === 0 ? (
          <div className="text-center mt-20">
            ...
            <p className="text-[#374151] text-lg font-bold">
          ...
          <div className="flex flex-col gap-4">
            {carrito.map((producto) => (
              ...
              >
                ...
                <div className="flex-1">
                  <p className="text-[#374151] font-medium line-clamp-2">
                    {producto.title}
                  </p>
            ...
            <div className="bg-white rounded-lg shadow p-6 mt-4">
              ...
              <button
                ...
                className="w-full bg-[#1E3A8A] text-white py-3 rounded-lg font-bold text-lg hover:bg-[#374151] transition-colors"
              >
                Finalizar compra
              </button>
            </div>
